          ...
          <div className="footer-content">
            ...
            <div className="footer-left">
              <div className="social-icons">
                ...
                <div className="Saloi143">
                  <a href="#">
                    <img src="src\assets\insta.png" alt="Mail" />
                  </a>
                  <a className="mail" href="#">
                    <img src="src\assets\gmail.png" alt="Contact" />
                  </a>
                </div>
                <br />
              </div>
            ...
            <div className="footer-right">
              ...
              <p className="event-description">
                Techcracy 2024 offers a diverse range of thrilling gaming
                competitions, technical challenges, and interactive workshops
